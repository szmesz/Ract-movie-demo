    ...
    render() {
        return(
            <form className="film-form" onSubmit={this.handleSubmit}>
                ...
                <label className="form-label">TITLE: <input className="form-input" placeholder="type in title" type="text" value={this.state.title} onChange={this.handleChange} /></label><br />
                <label className="form-label">RELEASE DATE: <input className="form-input" placeholder="type in title" type="date" value={this.state.release_date} onChange={this.handleChange} /></label><br />
